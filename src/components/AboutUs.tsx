  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-purple-900 mb-4">O nas</h2>
                ...
                {features.map((feature, index) => (
                  <Card key={index} className="border-none shadow-sm hover:shadow-md transition-shadow">
                    <CardContent className="p-4">
                      ...
                      <h4 className="font-semibold text-purple-900 mb-1">{feature.title}</h4>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-purple-900 mb-2">Bezpieczeństwo</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-purple-900 mb-2">Rozwój</h3>
            <p className="text-gray-600">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-purple-900 mb-2">Wsparcie</h3>
            <p className="text-gray-600">
