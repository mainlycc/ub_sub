        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/regulamin" className="text-white hover:text-gray-300 transition-colors">
                  Regulamin
                </Link>
              </li>
              <li>
                <Link href="/polityka-prywatnosci" className="text-white hover:text-gray-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white text-sm">Poniedziałek - Piątek: 9:00 - 17:00</li>
              <li className="text-white text-sm">Sobota: 9:00 - 14:00</li>
              <li className="text-white text-sm">Niedziela: Zamknięte</li>
            </ul>
