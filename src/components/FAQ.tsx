...
const FAQItem = ({ question, answer, accentColor, hoverColor, bgColor }: FAQItemProps) => {
  ...
  return (
    <div className={`border-b border-black/10 last:border-b-0 ${isOpen ? bgColor : ''}`}>
      <button
...
const FAQ = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white to-[#FFBAC4]/20" id="faq">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="inline-block py-1 px-3 bg-[#FFBAC4] text-black rounded-full text-sm font-semibold mb-3">
            FAQ
          </span>
        ...
        <div className="bg-[#FFBAC4] rounded-2xl p-8 shadow-xl mb-12">
        ...
        <div className="mt-12 text-center">
          ...
          <a 
            href="/kontakt" 
            className="inline-block py-3 px-8 bg-[#300FE6] hover:bg-[#2208B0] text-white font-medium rounded-lg transition-colors duration-300 shadow-md"
          >
            Napisz do nas
          </a>
        </div>
